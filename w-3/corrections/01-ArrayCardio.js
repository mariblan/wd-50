...
//WIth name function
const filteringYears = (year) => {
  return year >= 1500 && year <= 1600;
};

const yearsIn16th = yearOfBirth.filter(filteringYears);
// console.log(yearsIn16th);

//with anonymouse function

const yearsIn16th2 = yearOfBirth.filter((year) => {
  return year >= 1500 && year <= 1600;
});
// console.log(yearsIn16th);

// one line return
const yearsIn16th3 = yearOfBirth.filter((year) => year >= 1500 && year <= 1600);
// console.log(yearsIn16th);

// without addint it to a variable
console.log(
  yearOfBirth.filter((year) => {
    return year >= 1500 && year <= 1600;
  })
);

// Array.prototype.indexOf()
// 2. Find the index of the items in the expected output of step 1 and log
// them into the console.
// Expected output: 3 and 4.

// console.log(yearOfBirth.indexOf(yearsIn16th3[0]));
// console.log(yearOfBirth.indexOf(yearsIn16th3[1]));

// store values in variables

const index1 = yearOfBirth.indexOf(1571);
const index2 = yearOfBirth.indexOf(1564);
// console.log(index1);
// console.log(index2);

// Array.prototype.push()
// 3. Add the expected output of step 2 into a new array named arrayOfIndex and log
// it into the console.
// Expected output: [3, 4]
const arrayOfIndex = [];
console.log(arrayOfIndex);
arrayOfIndex.push(index1);
arrayOfIndex.push(index2);
console.log(arrayOfIndex);

// Array.prototype.filter()
// 4. Find out which elements of the scientifics array have the same index as the
// items of the yearOfBirth that were outputted to the console in step 1 and log it
// into the console.
// Expected output: [Johanes Kepler, Galileo Galilei].
//   const index1 = yearOfBirth.indexOf(1571);
//   const index2 = yearOfBirth.indexOf(1564);
const scientificsBornIn15 = scientifics.filter((scientific) => {
  return (
    scientifics.indexOf(scientific) === index1 ||
    scientifics.indexOf(scientific) === index2
  );
});
console.log(scientificsBornIn15);


const scientificsBornIn16th = scientifics.filter((scientific, index) => {
  return index === index1 || index === index2;
});
console.log(scientificsBornIn16th);
