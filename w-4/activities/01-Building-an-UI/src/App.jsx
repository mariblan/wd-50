    ...
    <>
      ...
      <div className='row'>
        ...
        <div className='block1'>
          ...
          <p>
            In our beautiful shelter we have lots of animals with quirky
            qualities to them. Are you in search of a challenge? Here you can
            ...
            <div className='cardsContainer'>
              <div className='card'>
                ...
                <p>
                  ...
                  never finished! And if something falls on the floor, it will
                  be gone before you can count to three! Take him back home with
                  you!
                </p>
              </div>
              <div className='card'>
                ...
                <p>
                  ...
                  with younger cats and kids, until a darn youngster tries to
                  take her out of her cool. She dislikes being picked up and
                  will let you know just how much she dislikes it if you try to,
                  so best to leave her to her own antics. Olly really likes to
                  nibble on feet at night so make sure to wear thick socks while
                  sleeping! Take her back home with you!
                </p>
              </div>
            </div>
          </section>
            ...
            <div className='cardsContainer'>
              <div className='card'>
                ...
                <p>
                  ...
                  business, so you will never receive unwanted mail again (or
                  any other kind). She enjoys the ocasional fetch ball game, but
                  in general she would rather eat your shoes or dig a hole where
                  you just planted that new Gardenia. Take her with you back
                  home!
                </p>
              </div>
            </div>
